 <?php 
 	...
 	var_dump($this->request->data['Client']);
 	...
 	echo $this->Form->input('situacao_alterado', array('type' => 'select', 'label' => 'Status', 'options' => $situacoes, 'value' => $this->request->data['Client']['situacao']));
